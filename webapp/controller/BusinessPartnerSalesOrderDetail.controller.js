sap.ui.define([
	...
	return Controller.extend("com.techedge.training.FlexibleColumnLayoutApp.controller.BusinessPartnerSalesDetail", {
		...
		onSalesOrderItemDialogOpen: function(bFromCreate, oItemBindingContextPath) {
			...
			if (!this._oEditDialog) {
				this._oEditDialog = sap.ui.xmlfragment(this.getView().getId(), "com.techedge.training.FlexibleColumnLayoutApp.view.fragment.dialog.SaleOrderItemEditDialog", this);
		...
		handleViewSettingsDialogButtonOpen: function(oEvent) {
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment(this.getView().getId(), "com.techedge.training.FlexibleColumnLayoutApp.view.fragment.dialog.SaleOrderItemViewSettingDialog", this);
